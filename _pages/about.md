...
**Lingyuan Meng** is a PhD student at <i class="fas fa-university"></i> **National University of Defense Technology (NUDT)**, supervised by <a href="https://xinwangliu.github.io/" class="link-accent"> Prof. Xinwang Liu He also earned my M.S. degree in Colledge of Computer and  from <i class="fas fa-university"></i> **NUDT**.  His research interests include graph neural network, AI4Science, and clustering. He has published more than 20 papers including TPAMI, TKDE, and NeuriPS, ICML, CVPR, with 1 ESI Hot Paper, 2 ESI Highly Cited Papers, and 1100 citations. 

<div class="quote-accent">
My research interests include graph learning, knowledge graphs, and AI4Science, with a particular focus on using **Graph Learning** techniques to solve problems in the fields of medicine and bioinformatics.
</div>

Feel free to reach out if you'd like to discuss research or explore potential collaboration! (mly_edu@163.com)

<div class="highlight-blocks">
  <div class="highlight-block floating-card">
    <h3><i class="fas fa-microscope"></i> AI Researcher</h3>
    <ul>
      <li>Research focus on **Graph Learning** and **AI4Science** </li>
      <li>Internships at top institutions
      <li>Publications at CCF A Conferences and IEEE Trans. Journels over 20+</li>
    </ul>
  </div>
  
  <div class="highlight-block floating-card">
    <h3><i class="fas fa-pen-fancy"></i> Engineering Developers</h3>
    <ul>
      <li>GitHub repository with over **1600 Stars**</li>
      <li>Extensive project experience</li>
      <li>Good drawing aesthetics</li>
    </ul>
  </div>
  ...
  <div class="highlight-block floating-card">
    ...
    <ul>
      <li>Holds a **fitness instructor certificate**</li>
      <li>Like **FPS games** like PUBG</li>
...
<div class='paper-box floating-card'>
  <div class='paper-box-image'>
    <div class="badge pulse-accent">ICML 2026 Spotlight</div>
    <img src='images/icml.png' alt="PhenoBrain Framework Architecture" width="100%">
  </div>
...
<div class='paper-box floating-card'>
  <div class='paper-box-image'>
    <div class="badge pulse-accent">IEEE TKDE 2025</div>
    <img src='images/tkde.png' alt="FedEAN Framework Overview" width="100%">
  </div>
  <div class='paper-box-text'>
...
<div class='paper-box floating-card'>
  <div class='paper-box-image'>
    ...
    <img src='images/aaai.png' alt="BrainCKT Framework Overview" width="100%">
  </div>
  <div class='paper-box-text'>
...
- *2025.03 - Present*: &nbsp;PhD of Colledge of Computer Science, National University of Defense Technology</span>.
- *2022.09 - 2024.12*: &nbsp;Master of Colledge of Computer Science, National University of Defense Technology</span>.
...
<div class="paper-box floating-card">
  <div class="paper-box-image">
    <div class="badge pulse-accent">Awesome-Knowledge-Graph-Reasoning</div>
    <div style="display:flex;align-items:center;justify-content:center;height:100%;background:linear-gradient(135deg,#0f172a 0%,#1e40af 60%,#0ea5e9 100%);color:#fff;border-radius:8px;padding:24px;text-align:center;">
      <div>
        ...
        <div style="font-family:ui-monospace,Menlo,monospace;font-weight:700;font-size:1.05em;">Awesome-Knowledge-Graph-Reasoning</div>
        <div style="opacity:0.85;font-size:0.85em;margin-top:6px;">3 Knowledge Graphs · 200+ Models · 50+ Datasets</div>
      </div>
    </div>
  </div>
  <div class="paper-box-text">
    <h3><a href="/skills/" style="color: inherit; text-decoration: none;">Awesome-Knowledge-Graph-Reasoning</a></h3>
    <div class="authors">A survey of knowledge graph reasoning on graph types: Static, dynamic, and multi-modal</div>
    <div class="venue">Published at IEEE Transactions on Pattern Analysis and Machine Intelligence (IEEE TPAMI) with 500 citations and 1400+ github stars!</div>
    <div class="links">
      <a href="https://github.com/LIANGKE23/Awesome-Knowledge-Graph-Reasoning" class="btn-accent"><i class="fab fa-github"></i> GitHub</a>
    </div>
  </div>
</div>
